...
function AIFeedback({ taskType, prompt, response, onClose }) {
  ...
  useEffect(() => {
    (async () => {
      try {
        const apiUrl = (typeof import.meta !== "undefined" && import.meta.env?.VITE_API_URL) || "https://apspanish-simulation-production.up.railway.app";
...
Respond ONLY with valid JSON, no markdown, no extra text:
{
  ...
  "encouragement": "One motivating sentence tailored to this student's performance"
      ...
      try {
        const apiUrl2 = (typeof import.meta !== "undefined" && import.meta.env?.VITE_API_URL) || "https://apspanish-simulation-production.up.railway.app";
